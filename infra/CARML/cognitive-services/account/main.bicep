...
@description('Optional. Models to be deployed.')
...
@batchSize(1)
resource csDeployment 'Microsoft.CognitiveServices/accounts/deployments@2023-05-01' = [for deployment in deployments: {
